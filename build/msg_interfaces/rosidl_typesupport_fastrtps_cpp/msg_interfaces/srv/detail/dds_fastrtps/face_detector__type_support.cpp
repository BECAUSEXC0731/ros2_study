...
#include "msg_interfaces/srv/detail/face_detector__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msg_interfaces::srv::FaceDetector_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_interfaces::srv::FaceDetector_Request & ros_message)
{
  // Member: image
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_interfaces::srv::FaceDetector_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_interfaces::srv::FaceDetector_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_interfaces::srv::FaceDetector_Request *>(
    untyped_ros_message);
...
{
  return &msg_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interfaces, srv, FaceDetector_Request)() {
  return &msg_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_msg_interfaces
cdr_serialize(
  const msg_interfaces::srv::FaceDetector_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: number
  cdr << ros_message.number;
  // Member: usetime
  cdr << ros_message.usetime;
  // Member: top
  {
    cdr << ros_message.top;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_interfaces::srv::FaceDetector_Response & ros_message)
{
  // Member: number
  cdr >> ros_message.number;
  ...
  size_t current_alignment)
{
  ...
  // Member: usetime
  {
    size_t item_size = sizeof(ros_message.usetime);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: top
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_interfaces::srv::FaceDetector_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_interfaces::srv::FaceDetector_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<msg_interfaces::srv::FaceDetector_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &msg_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interfaces, srv, FaceDetector_Response)() {
  return &msg_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Response__handle;
}
...
{
  return &msg_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interfaces, srv, FaceDetector)() {
  return &msg_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector__handle;
}
