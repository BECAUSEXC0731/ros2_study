...
class FaceDetector_Response(metaclass=Metaclass_FaceDetector_Response):
    ...
    def __init__(self, **kwargs):
        ...
        self.usetime = kwargs.get('usetime', float())
    ...
    @builtins.property
    def usetime(self):
        """Message field 'usetime'."""
        return self._usetime

    @usetime.setter
    def usetime(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'usetime' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'usetime' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._usetime = value
...
class Metaclass_FaceDetector(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'msg_interfaces.srv.FaceDetector')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from msg_interfaces.srv import _face_detector
...
class FaceDetector(metaclass=Metaclass_FaceDetector):
    from msg_interfaces.srv._face_detector import FaceDetector_Request as Request
    from msg_interfaces.srv._face_detector import FaceDetector_Response as Response
